...
vex::motor left_2(vex::PORT20, vex::gearSetting::ratio18_1, false);
vex::motor arm(vex::PORT15, vex::gearSetting::ratio36_1, false);
vex::motor hand1(vex::PORT9, vex::gearSetting::ratio36_1, true);
vex::motor hand2(vex::PORT12, vex::gearSetting::ratio36_1, false);
