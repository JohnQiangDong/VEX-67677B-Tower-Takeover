...
void auto_bd(){
  ...
  //turn right 35
  turnTarget(37,63,brake,4,0.3,0.2);//37
  ...
  moveTarget_LR(200, 250, 60, brakeType::brake, 0.2, 0.01, 0.3);//355,255
 ...
 // task PushInAuToBD(push_in_auto_bd);
  moveTarget(700,40,true, brakeType::brake, 0.3, 0.01,0.3); 
  handsStop(vex::brakeType::coast, 0.15);

  moveTarget_LR(140, 280, 40, brakeType::brake, 0.2, 0.1, 0.3);//355,255  
